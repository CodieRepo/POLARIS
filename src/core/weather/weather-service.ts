    ...
    if (ncporObs) {
      ...
      const weather: StationWeather = {
        ...
        derivedCalculations: {
          ...
          currentSolarElevationDeg: solar.currentSolarElevationDeg,
          dailySolarMinimumDeg: solar.dailySolarMinimumDeg,
          dailySolarMaximumDeg: solar.dailySolarMaximumDeg,
          solarDeclinationDeg: solar.solarDeclinationDeg,
          solarRegime: solar.solarRegime,
          operationalVisibilityHeuristic: solar.operationalVisibilityHeuristic,
        },
