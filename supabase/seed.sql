...
VALUES
  ...
  ('f0000000-0000-0000-0000-000000000009', 'LGT-SKD-01', 'Decommissioned Skidoo Alpine II', 'VEHICLES', 'Snowmobile', 'b0000000-0000-0000-0000-000000000004', 'RETIRED', 'CRITICAL', 'LOW', 'Bombardier', 'Alpine II 1989', '1989-12-01T00:00:00Z', 'SIMULATED')
ON CONFLICT (id) DO NOTHING;
